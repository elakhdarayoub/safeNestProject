  ...
  return (
    <div className="relative w-full aspect-square max-w-[500px] flex items-center justify-center">
      ...
      >
        ...
        <span className="text-[9px] text-brand-primary font-mono mt-1 uppercase tracking-widest">Core</span>
      </motion.div>
      ...
      >
        ...
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity z-30">
          <div className="bg-elevated border border-border-subtle text-[11px] px-3 py-1 rounded text-content-secondary">Data Lake - Syncing</div>
        </div>
      </motion.div>
      ...
      >
        ...
        />
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity z-30">
          <div className="bg-elevated border border-border-subtle text-[11px] px-3 py-1 rounded text-content-secondary">API Gateway - Online</div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity z-30">
          <div className="bg-elevated border border-border-subtle text-[11px] px-3 py-1 rounded text-content-secondary">Edge Device Cluster - Connected</div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max opacity-0 group-hover:opacity-100 transition-opacity z-30">
          <div className="bg-elevated border border-border-subtle text-[11px] px-3 py-1 rounded text-content-secondary">Processing Node - Active</div>
        </div>
      </motion.div>
    </div>
  );
